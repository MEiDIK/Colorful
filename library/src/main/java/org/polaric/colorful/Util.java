...
public final class Util {
    ...
    static void setToolbarTitleColorCompat(@NonNull AppCompatActivity activity, @ColorInt int color, @NonNull Toolbar toolbar) {
        toolbar.setTitleTextColor(color);
        toolbar.setSubtitleTextColor(color);
    }

    static void setToolbarNavigationIconColorCompat(@NonNull AppCompatActivity activity, @ColorInt int color, @NonNull Toolbar toolbar) {
